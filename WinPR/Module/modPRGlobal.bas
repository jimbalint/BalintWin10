...
Public Sub SetEquates()
    ...
    PREquate.GlobalTypeOHW2Company = 70
    ...
    PREquate.PRW4Standard = 0
    PREquate.PRW4Single = 1
    PREquate.PRW4Married = 2
    PREquate.PRW4HOH = 3
...
Dim LastYear, YearCount As Integer

    YearCount = 0
    LastYear = -1
    SQLString = "SELECT DISTINCT INT(YearMonth / 100) as yYear FROM PRHist ORDER BY INT(YearMonth / 100) DESC"
    ...
    yrs.MoveFirst
    Do
        cmbYr.AddItem yrs!yYear
        If yrs!yYear = Year(Date) - 1 Then
            LastYear = YearCount
        End If
    ...
    Select Case Month(Now())
        Case 1
            ...
            ' 2024-01-13
            If LastYear <> -1 Then cmbYr.ListIndex = LastYear
        Case 2 To 4
