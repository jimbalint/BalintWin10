...
'    End If
    ...
    PrintValue(1) = "":                                     FormatString(1) = "a5"
    PrintValue(2) = "NUMBER OF RECORDS:":                   FormatString(2) = "a65"
    PrintValue(3) = HistCount:                              FormatString(3) = "n3"
    PrintValue(4) = " ":                                    FormatString(4) = "~"
    FormatPrint
    Ln = Ln + 3
        ...
        If PRItem.GetBySQL(SQLString) Then
            Do
                ...
                If trsEntry.EOF Then
                    MsgBox "EER item NF - EE " & PREmployee.EmployeeID & " Item " & PRItem.ItemID, vbExclamation
                    GoBack
                End If
...
Dim FedID As String
    ...
    If frmDirectDep.chkOutputFile Then
        ...
        ' 2015-08-120 - special for Conti - store for the balance entry "6"
        ...
        ' 2015-08-17 - special switch for Conti
        If InStr(1, LCase(PRCompany.Name), "conti") <> 0 Then
            If PRCompany.DirDepUseAltID = 1 Then
                FedID = " " & Left(PRCompany.FederalID, 2) & Mid(PRCompany.FederalID, 4, 7)
            End If
        End If
