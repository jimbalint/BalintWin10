...
Begin VB.Form frmCityTaxRpt 
   ...
   Begin VB.CheckBox chkSepCourtesy 
      Caption         =   "Separate Courtesy Tax"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   11.25
         Charset         =   0
...
Private Sub cmdDateRange_Click()
    ...
    frmDateRange.lblProgram = "CITY TAX REPORT"
...
Private Sub cmdOK_Click()
    If StartDate = 0 And EndDate = 0 And BatchNumbr = 0 And PEDate = 0 Then
        MsgBox "PLEASE SELECT A DATE RANGE", vbCritical, "City Tax Report"
    Else
        InitFlag = True
        CityTaxRpt RangeType, BatchNumbr, CLng(Int(PEDate)), CLng(Int(CheckDt)), _
