...
Public Sub CustomerCreate()
    ...
    AddField "Customer", "Addr1Bold", "Byte", cn
    AddField "Customer", "Addr2Bold", "Byte", cn
    AddField "Customer", "Addr3Bold", "Byte", cn
    AddField "Customer", "Addr4Bold", "Byte", cn
    ...
    AddField "Customer", "AccountSpace", "Byte", cn
    AddField "Customer", "TwoSignLines", "Byte", cn
    AddField "Customer", "SignImage1", "Char (40)", cn
    AddField "Customer", "Sign1Left", "Long", cn
    AddField "Customer", "Sign1Top", "Long", cn
    AddField "Customer", "Sign1Height", "Long", cn
    AddField "Customer", "Sign1Width", "Long", cn
    AddField "Customer", "SignImage2", "Char (40)", cn
    AddField "Customer", "Sign2Left", "Long", cn
    AddField "Customer", "Sign2Top", "Long", cn
    AddField "Customer", "Sign2Height", "Long", cn
    AddField "Customer", "Sign2Width", "Long", cn
