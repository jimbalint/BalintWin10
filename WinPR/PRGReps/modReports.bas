...
Dim Col1X, Col2X, Col3X, Col4X As Long
    ...
    With frm941_2010A
        ...
        PosPrint 10200, 3410, PadRight(Format(.Line1, "##,##0"), 6)
        
        PosPrint 9400, 3890, PadRight(Format(.Line2, FmtString), 13)
        PosPrint 9400, 4370, PadRight(Format(.Line3, FmtString), 13)
        ...
        PosPrint 4000, 5570, PadRight(Format(.Line5a, FmtString), 13)
        PosPrint 6900, 5570, PadRight(Format(.Line5aa, FmtString), 13)
        
        PosPrint 4000, 6040, PadRight(Format(.Line5b, FmtString), 13)
        PosPrint 6900, 6040, PadRight(Format(.Line5bb, FmtString), 13)
        
        PosPrint 4000, 6540, PadRight(Format(.Line5c, FmtString), 13)
        PosPrint 6900, 6540, PadRight(Format(.Line5cc, FmtString), 13)
        PosPrint 9400, 7000, PadRight(Format(.Line5d, FmtString), 13)
        
        ' *** start new formatting for Rev April 2010 ***
        HorzPosn = 7350
        VertPosn = 7262
        VertSpace = 485
        
        PosPrint HorzPosn, VertPosn, PadRight(Format(.Line6a, "##,##0"), 7)
        VertPosn = VertPosn + VertSpace
        PosPrint HorzPosn, VertPosn, PadRight(Format(.Line6b, "##,##0"), 7)
        
        VertPosn = VertPosn + VertSpace
        PosPrint 5950, VertPosn - 65, PadRight(Format(.Line6c, FmtString), 13)
        PosPrint 9400, VertPosn - 65, PadRight(Format(.Line6d, FmtString), 13)
        PosPrint 9400, VertPosn + 270, PadRight(Format(.Line6e, FmtString), 13)
        
        VertPosn = 8900
        VertSpace = 463
        PosPrint 6900, VertPosn, PadRight(Format(.Line7a, FmtString), 13)
        VertPosn = VertPosn + VertSpace
        PosPrint 6900, VertPosn, PadRight(Format(.Line7b, FmtString), 13)
        VertPosn = VertPosn + VertSpace
        PosPrint 6900, VertPosn, PadRight(Format(.Line7c, FmtString), 13)

        VertPosn = 10310
        PosPrint 9400, VertPosn, PadRight(Format(.Line8, FmtString), 13)
        VertPosn = VertPosn + VertSpace
        PosPrint 9400, VertPosn, PadRight(Format(.Line9, FmtString), 13)
        VertPosn = VertPosn + VertSpace
        PosPrint 9400, VertPosn, PadRight(Format(.Line10, FmtString), 13)
        VertPosn = VertPosn + VertSpace
        PosPrint 9400, VertPosn, PadRight(Format(.Line11, FmtString), 13)
        
        HorzPosn = 4650
        VertPosn = 12060
        PosPrint HorzPosn, VertPosn, PadRight(Format(.Line12a, FmtString), 13)
        VertPosn = VertPosn + VertSpace
        PosPrint HorzPosn, VertPosn, PadRight(Format(.Line12b, FmtString), 13)
        VertPosn = VertPosn + VertSpace
        PosPrint HorzPosn, VertPosn, PadRight(Format(.Line12c, FmtString), 13)
        VertPosn = VertPosn + VertSpace
        PosPrint HorzPosn, VertPosn, PadRight(Format(.Line12d, FmtString), 13)
        PosPrint 9400, VertPosn, PadRight(Format(.Line12e, FmtString), 13)

        VertPosn = 13945
        PosPrint 9400, VertPosn, PadRight(Format(.Line13, FmtString), 13)
        VertPosn = VertPosn + VertSpace
        PosPrint 9400, VertPosn, PadRight(Format(.Line14, FmtString), 13)
        VertPosn = VertPosn + VertSpace
        PosPrint 6850, VertPosn, PadRight(Format(.Line15, FmtString), 13)

        PosPrint 9600, 14340, .AlphaCheckLine15a
        PosPrint 9600, 14520, .AlphaCheckLine15b     '  over   down
    ...
    '
        ...
        PosPrint 2660, 14450, .AlphaCheckPart5
